...
#define _DEF_HEARTBEAT_TIMEOUT_SEC        30    // 基础超时：软断(fd无效)到此时硬离线；在线则检测弱网
#define _DEF_HEARTBEAT_WEAKNET_TIMEOUT_SEC 60  // 弱网降级超时：fd仍有效时延长至此再硬离线
...
// CheckHeartBeat：满 30s 查 USER_INFO.fd；fd 无效→硬离线；fd 有效→弱网，等满 60s 再硬离线
